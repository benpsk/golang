...
func (cfg *apiConfig) handlerFeedFollowCreate(w http.ResponseWriter, r *http.Request, user database.User) {
	...
	if err != nil {
		respondWithError(w, http.StatusInternalServerError, "Couln't decode parameters")
		return
	}
	...
	if err != nil {
		respondWithError(w, http.StatusInternalServerError, "Couln't create feed follow")
		return
	}
